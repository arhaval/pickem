...
ADD COLUMN IF NOT EXISTS prediction_lock_minutes_before_match integer DEFAULT 0;
...
-- Mevcut kayıtlar için varsayılan değeri ayarla (eğer NULL ise)
UPDATE public.site_settings
SET prediction_lock_minutes_before_match = COALESCE(prediction_lock_minutes_before_match, 0)
WHERE id = 1;
